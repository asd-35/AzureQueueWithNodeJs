import { Constants as Constants$1, ProtocolMode, LogLevel, StringUtils, AccountEntity, CacheManager, IdTokenEntity, AccessTokenEntity, RefreshTokenEntity, AppMetadataEntity, ServerTelemetryEntity, ThrottlingEntity, TokenCacheContext, ServerTelemetryManager, Logger, TrustedAuthority, AuthorityFactory, AuthorizationCodeClient, ResponseMode, AuthenticationScheme, RefreshTokenClient, SilentFlowClient, ClientAuthError, DeviceCodeClient, UsernamePasswordClient, TimeUtils, ClientCredentialClient, OnBehalfOfClient } from '@azure/msal-common';
...
var ClientApplication = /*#__PURE__*/function () {
  ...
  _createClass(ClientApplication, [{
    ...
    get: function get() {
      ...
      this._authority = AuthorityFactory.createInstance(this.config.auth.authority, this.config.system.networkClient, this.config.auth.protocolMode);
      return this._authority;
    }
  }]);
...
var ClientAssertion = /*#__PURE__*/function () {
  ...
  ClientAssertion.parseCertificate = function parseCertificate(publicCertificate) {
     ...
     */
    var regexToFindCerts = /-----BEGIN CERTIFICATE-----\n(.+?)\n-----END CERTIFICATE-----/gm;
    var certs = [];
    var matches;
